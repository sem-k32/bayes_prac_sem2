...
class MyAlphaExpansion(NormAlphaExtension):
    ...
    def build_init_seg_matr(self) -> np.ndarray:
        ...
        # learn "water pixel"
        self._water_pixel_ = np.mean(self.image_[250:280, 300:350], axis=(0, 1))
        ...
        # learn "green pixel"
        self._green_pixel_ = np.mean(self.image_[150:170, 90:110], axis=(0, 1))
        # find scale factor for uno potential
...
def main():
    ...
    reduce_factor = 5
    image = Image.open("data/archive/Image/11.jpg").reduce(reduce_factor)
    ...
    cur_results_path = f"experiments/alpha_expansion/experiment_photo_11/results_init"
